 ...
 <form action="" method="post">
      <div id="login" class="login">
        <div class="login-icon-field">
          <img class="login-icon" src="images/logo.png" alt="">
        </div>
        <div class="login-form">
          <div class="username-row">
            ...
            <input type="text" id="username_input" class="username-input" placeholder="Username" name="username">
          </div>
          <div class="password-row">
            ...
            <input type="password" id="password_input" class="password-input" class="input" placeholder="Password" name="password">
          </div>
        </div>
        <div class="call-to-action">
          <button id="login-button" type="submit">Log In</button>
          <p>Nemate nalog? <a>Registrujte se</a></p>
        </div>
      </div>
  </form>
  <div>
